...
function takeCommand(message){
    if(message.includes('hey') || message.includes('hello')){
        ...
        speak("Sir Im ORION,Omniscient Responsive Intelligent Operations Network")
    }
    else if(message.includes("are you jarvis?")){
        speak("No I'm not Jarvis. I am a ORION,Omniscient Responsive Intelligent Operations Network")
    }
    ...
    else if(message.includes("Orion tell me your introduction")){
        speak("Sure Im ORION Omniscient Responsive Intelligent Operations Network,im a human Developed program")
    }
